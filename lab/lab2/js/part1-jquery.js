...
$('#checkbox-label1').text('Kayak Rentals');
$('#checkbox-label2').text('Paddleboard Rentals');
$('#color-label').text('Marker Color');

//Task 2
$('#text-input1').val('Aqua Trails');
$('#text-input2').val('38.944892');
$('#text-input3').val('-74.899695');
$('#numeric-input').val('1 Mile');
...
var Company = {
  ...
  Founded: $('#numeric-input').val(),
  Kayak: $('#cbox-input1').prop("checked"),
  Paddleboard: $('#cbox-input2').prop("checked"),
...
//Task 6
  ...
  L.circleMarker([myCompany.Lat,myCompany.Long],geojsonMarkerOptions).addTo(map).bindPopup(myCompany.Name);
});
...
$( "button" ).click(function() {
  L.marker([$('#text-input2').val(),$('#text-input3').val(), myCompany.LAT, myCompany.LNG],{icon: myIcon}).addTo(map);
});
